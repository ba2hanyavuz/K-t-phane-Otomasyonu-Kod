...
{
    public partial class kitapGozat : Form
    {
        public kitapGozat()
        {
            InitializeComponent();
        ...
        private void kitapBilgi_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            int k;
            try
            {
        ...
        private void kitapGozat_Load(object sender, EventArgs e)
        {
