...
{
    public partial class uyeAyarlari : Form
    {
        public uyeAyarlari()
        {
            InitializeComponent();
        ...
        private void uyeAyarlari_Load(object sender, EventArgs e)
        {
            uyenolabel.Text = Uyegiris.uyeid.ToString();
            conn.Open();
            SqlCommand kmt = new SqlCommand("Select * from uye where uye_id = '" + uyenolabel.Text + "'", conn);
        ...
        private void guncelle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                cmd.Connection = conn;
                cmd.CommandText = "update uye set uye_ad= '" + adTextBox.Text + "'" + ",uye_soyad= '" + soyadTextBox.Text + "', telefon='" + telefonTextBox.Text + "',email='" + emailTextBox.Text + "',kullanici_adi='" + kullaniciTextBox.Text + "',sifre='" + sifreTextBox.Text + "' where uye_id= " + Uyegiris.uyeid + "";
                cmd.ExecuteNonQuery();
                conn.Close();
